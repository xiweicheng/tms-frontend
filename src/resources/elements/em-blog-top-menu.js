...
export class EmBlogTopMenu {
    ...
    createDrawHandler() {
        $('.em-blog-write-draw > iframe').attr('src', this.baseRes + 'cdn/drawio/index.html?embed=1&lang=zh&ui=simple&dark=auto&offline=1&title=123&spin=1&modified=unsavedChanges&proto=json&noSaveBtn=1&noExitBtn=1&edit=1&saveAndExit=0' + '&_=' + new Date().getTime());
